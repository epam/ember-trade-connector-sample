...
import deltix.connector.fix.message.FixReplaceOrderRequest;
import deltix.efix.message.Message;
import deltix.efix.message.builder.MessageBuilder;
import deltix.efix.message.field.Tag;

public class FixReplaceOrderRequestCodec<M extends FixReplaceOrderRequest> implements FixCodec<M> {
    ...
    @Override
    public void encode(FixReplaceOrderRequest request, MessageBuilder builder) {
    ...
    @Override
    public void decode(FixReplaceOrderRequest response, Message message) {
