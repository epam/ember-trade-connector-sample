...
public class DeltixNewOrderRequestCodec<M extends DeltixNewOrderRequest> implements FixCodec<M> {
    private final AsciiStringFlyweight orderId = new AsciiStringFlyweight();

    @Override
    public void encode(DeltixNewOrderRequest request, MessageBuilder builder) {
    ...
    @Override
    public void decode(DeltixNewOrderRequest response, Message message) {
